...
enum HistogramValue {
  ...
  JEMAOS_SHELL_CLIENT_SYSTEM_NOTIFICATION = 563,
  JEMAOS_SHELL_CLIENT_COMMAND_NOTIFICATION = 564,
  JEMAOS_SHELL_CLIENT_CUSTOM_NOTIFICATION = 565,
  ARC_APPS_PRIVATE_ON_REMOVED = 566,
  ARC_APPS_PRIVATE_ON_INSTALLATION_STARTED = 567,
  ARC_APPS_PRIVATE_ON_INSTALLATION_PROGRESS_CHANGED = 568,
  ARC_APPS_PRIVATE_ON_INSTALLATION_FINISHED = 569,
  JEMAOS_LICENSE_INVALID_NOTIFICATION = 570,
  JEMAOS_LICENSE_VALID_NOTIFICATION = 571,
