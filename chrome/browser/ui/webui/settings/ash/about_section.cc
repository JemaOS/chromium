...
void AboutSection::AddLoadTimeData(content::WebUIDataSource* html_source) {
  ...
  html_source->AddString("aboutJemaOSVersion",
                         VersionUI::GetJemaOSVersionStringForUi());
  ...
  html_source->AddString("jemaosLicenseUrl", jemaos::switches::GetJemaOSLicenseUrl());
