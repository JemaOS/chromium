...
class JemaAssistantWebUIHandler
 ...
 public:
  ...
  void OnBubbleQueryChanged(const JemaAssistantViewObserver::ClipboardItemForAssistant& item) override;
 ...
 private:
  ...
  raw_ptr<JemaAssistantAppUI, ExperimentalAsh> jema_assistant_app_ui_;
...
#endif // !#ifndef ASH_WEBUI_JEMA_ASSISTANT_APP_UI_JEMA_ASSISTANT_APP_WEBUI_HANDLER_H_
