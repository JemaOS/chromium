...
enum HistogramValue {
  ...
  NETWORKINGPRIVATE_VERIJEMASTINATION = 419,
  ...
  DELETED_NETWORKINGCASTPRIVATE_VERIJEMASTINATION = 1164,
  ...
  NATIVE_WINDOWS_GET = 1784,
  NATIVE_WINDOWS_GETALL = 1785,
  NATIVE_WINDOWS_UPDATE = 1786,
  NATIVE_WINDOWS_REMOVE = 1787,
  NATIVE_WINDOWS_CREATE = 1788,
  APP_MANAGEMENT_GETAPPLIST = 1789,
  APP_MANAGEMENT_INSTALLWEBAPP = 1790,
  APP_MANAGEMENT_INSTALLARCAPP = 1791,
  COMMAND_LINE_HASSWITCH = 1792,
  COMMAND_LINE_REMOVESWITCH = 1793,
  COMMAND_LINE_ADDSWITCH = 1794,
  APP_MANAGEMENT_GETARCPOLICY = 1795,
  SHELL_SYNC_EXEC = 1796,
  SHELL_ASYNC_EXEC = 1797,
  SHELL_GET_TASK_STATE = 1798,
  SHELL_GET_TASK_OUTPUT = 1799,
  SHELL_GET_DAEMON_STATE = 1800,
  SHELL_FORCE_CLOSE_TASK = 1801,
  JEMAOS_ARC_STATUS_GET = 1802,
  INPUT_IME_SHOW_JEMA_LANGUAGE_STATE = 1803,
  ARCAPPSPRIVATE_REMOVEPACKAGE = 1804,
  ARCAPPSPRIVATE_INSTALLPACKAGE_FROM_PATH = 1805,
  JEMAOS_PRIVATE_GET_JEMAOS_INFO = 1806,
