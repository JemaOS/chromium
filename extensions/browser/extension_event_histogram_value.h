...
enum HistogramValue {
  ...
  JEMAOS_SHELL_CLIENT_SYSTEM_NOTIFICATION = 513,
  JEMAOS_SHELL_CLIENT_COMMAND_NOTIFICATION = 514,
  JEMAOS_SHELL_CLIENT_CUSTOM_NOTIFICATION = 515,
  ARC_APPS_PRIVATE_ON_REMOVED = 516,
  ARC_APPS_PRIVATE_ON_INSTALLATION_STARTED = 517,
  ARC_APPS_PRIVATE_ON_INSTALLATION_PROGRESS_CHANGED = 518,
  ARC_APPS_PRIVATE_ON_INSTALLATION_FINISHED = 519,
