...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCoralSavedDeskFeature);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kJemaAssistant);
COMPONENT_EXPORT(ASH_CONSTANTS)
extern const base::FeatureParam<base::TimeDelta>
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsCoralSavedDeskFeatureEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsJemaAssistantEnabled();
COMPONENT_EXPORT(ASH_CONSTANTS)
