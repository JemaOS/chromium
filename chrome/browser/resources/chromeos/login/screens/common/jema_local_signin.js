...
import '//resources/cr_elements/cr_input_oobe/cr_input_oobe.js';
 ...
 * @enum {number}
 */
/* #export */ const JEMA_LOCAL_SIGNIN_ERROR_STATE = {
  NONE: 0,
  BAD_USERNAME: 1,
  BAD_AUTH_PASSWORD: 2,
...
/* #export */ const JemaLocalSigninUIState = {
  SIGNUP: 'signup',
  SIGNIN: 'signin',
};
 ...
 */
const JemaLocalSigninBase = mixinBehaviors(
...
/* @polymer 
 */
class JemaLocalSignin extends JemaLocalSigninBase {
  static get is() {
    return 'jema-local-signin-element';
  }
  ...
  getOobeUIInitialState() {
    return OOBE_UI_STATE.JEMA_LOCAL_SIGNIN;
  }
  ...
  errorStateObserver_() {
    ...
    this.authPasswordInvalid = this.errorState === JEMA_LOCAL_SIGNIN_ERROR_STATE.BAD_AUTH_PASSWORD;
