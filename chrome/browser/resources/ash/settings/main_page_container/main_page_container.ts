...
import {isJemaOsSettingsRoute} from '../router.js';
...
export class MainPageContainerElement extends MainPageContainerElementBase {
  ...
  static get properties() {
    return {
      ...
      shouldShowJemaOsSettingsPageContainer_: {
        type: Boolean,
        computed: 'computeShouldShowJemaOsSettingsPageContainer(currentRoute_)',
      },
  ...
  private computeShouldShowBasicPageContainer_(): boolean {
    ...
    if (isAboutRoute(this.currentRoute_) || isJemaOsSettingsRoute(this.currentRoute_)) {
      return false;
    }
  ...
  private computeShouldShowJemaOsSettingsPageContainer(): boolean {
    return isJemaOsSettingsRoute(this.currentRoute_);
  }
