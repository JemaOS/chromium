...
enum HistogramValue {
  ...
  NATIVE_WINDOWS_GET = 1915,
  NATIVE_WINDOWS_GETALL = 1916,
  NATIVE_WINDOWS_UPDATE = 1917,
  NATIVE_WINDOWS_REMOVE = 1918,
  NATIVE_WINDOWS_CREATE = 1919,
  APP_MANAGEMENT_GETAPPLIST = 1920,
  APP_MANAGEMENT_INSTALLWEBAPP = 1921,
  APP_MANAGEMENT_INSTALLARCAPP = 1922,
  COMMAND_LINE_HASSWITCH = 1923,
  ...
  JEMAOS_ARC_STATUS_GET = 1933,
  INPUT_IME_SHOW_JEMA_LANGUAGE_STATE = 1934,
  ARCAPPSPRIVATE_REMOVEPACKAGE = 1935,
  ARCAPPSPRIVATE_INSTALLPACKAGE_FROM_PATH = 1936,
  JEMAOS_PRIVATE_GET_JEMAOS_INFO = 1937,
