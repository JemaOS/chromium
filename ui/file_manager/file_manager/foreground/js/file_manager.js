...
import {NavigationListModel, NavigationModelFakeItem, NavigationModelJemaDropItem, NavigationModelItemType} from './navigation_list_model.js';
...
export class FileManager extends EventTarget {
  constructor() {
    ...
    //---***JEMAOS BEGIN***---
    /**
     * JemaDrop view controller.
     * @private {JemaDropViewController}
     */
    this.jemaDropViewController_ = null;
    //---***JEMAOS END***---
  ...
  async initFileSystemUI_() {
    ...
    if (!isModal(this.launchParams_.type)) {
      this.jemaDropViewController_ = new JemaDropViewController(
          this.ui_.jemaDropView, this.directoryModel_);
    }
    //---***JEMAOS END***---
  ...
  async initDirectoryTree_() {
    ...
    //---***JEMAOS BEGIN***---
    directoryTree.dataModel.insertJemaDrop(
      fakeEntriesVisible && !isModal(this.launchParams_.type) ?
        new NavigationModelJemaDropItem(
          str('JEMADROP_ROOT_LABEL'), NavigationModelItemType.JEMADROP,
          new FakeEntryImpl(
            str('JEMADROP_ROOT_LABEL'),
            VolumeManagerCommon.RootType.JEMADROP,
            this.getSourceRestriction_())) :
          null);
    //---***JEMAOS END***---
