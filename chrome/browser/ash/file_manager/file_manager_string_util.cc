...
void AddStringsForJema(base::Value::Dict* dict) {
...
base::Value::Dict GetFileManagerStrings() {
  ...
  AddStringsForJema(&dict);
  AddStringsGeneric(&dict);

  if (jemaos::switches::IsJemaExtendAccountEnabled()) {
    dict.Set(
      "DOWNLOADS_LOW_SPACE_WARNING_HELP_URL",
      base::StringPrintf(jemaos::constants::kHelpURLFormat, kDownloadsLowSpaceWarningHelpNumber));
    dict.Set("FILES_APP_HELP_URL", jemaos::constants::kFileManagerHelpURL);

    dict.Set("GOOGLE_DRIVE_BUY_STORAGE_URL", jemaos::constants::kGoogleDriveBuyStorageUrl);
    dict.Set("GOOGLE_DRIVE_MANAGE_STORAGE_URL", jemaos::constants::kGoogleDriveHelpUrl);
    dict.Set(
      "GOOGLE_DRIVE_ERROR_HELP_URL",
      base::StringPrintf(jemaos::constants::kHelpURLFormat, kGoogleDriveErrorHelpNumber));
    dict.Set("GOOGLE_DRIVE_HELP_URL", jemaos::constants::kGoogleDriveHelpUrl);
    dict.Set("GOOGLE_DRIVE_OFFLINE_HELP_URL",
                      jemaos::constants::kGoogleDriveOfflineHelpUrl);
    dict.Set("GOOGLE_DRIVE_OVERVIEW_URL", jemaos::constants::kGoogleDriveOverviewUrl);
    dict.Set("GOOGLE_DRIVE_ROOT_URL", jemaos::constants::kGoogleDriveRootUrl);
    dict.Set(
      "NO_TASK_FOR_FILE_URL",
      base::StringPrintf(jemaos::constants::kHelpURLNoTaskForFile, kNoActionForFileHelpNumber));
  } else {
  dict.Set(
      "DOWNLOADS_LOW_SPACE_WARNING_HELP_URL",
  ...
  dict.Set("JEMA_DROP_URL", jemaos::constants::kJemaDropUrl);
...
void AddFileManagerFeatureStrings(const std::string& locale,
  ...
  // dict->Set("JEMA_ACCOUNT_ENABLED", profile && profile->IsJemaProfile());
