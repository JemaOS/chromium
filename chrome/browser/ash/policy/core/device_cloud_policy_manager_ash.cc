...
const char kZeroTouchEnrollmentJema[] = "jema";
const char kZeroTouchEnrollmentJemaForced[] = "jema-forced";
const char kZeroTouchEnrollmentJemaHandsOff[] = "jema-hands-off";
...
DeviceCloudPolicyManagerAsh::GetZeroTouchEnrollmentMode() {
  ...
  if (value == kZeroTouchEnrollmentJemaForced) {
    return ZeroTouchEnrollmentMode::JEMA_FORCED;
  }
  if (value == kZeroTouchEnrollmentJemaHandsOff) {
    return ZeroTouchEnrollmentMode::JEMA_HANDS_OFF;
  }
  if (value == kZeroTouchEnrollmentJema) {
    return ZeroTouchEnrollmentMode::JEMA_ENABLED;
  }
  if (value.empty()) {
