...
VolumeManagerCommon.RootTypesForUMA = [
  ...
  VolumeManagerCommon.RootType.JEMADROP,                  // 29
];
...
VolumeManagerCommon.getVolumeTypeFromRootType = rootType => {
  switch (rootType) {
    ...
    case VolumeManagerCommon.RootType.JEMADROP:
      return VolumeManagerCommon.VolumeType.JEMADROP;
  }
...
VolumeManagerCommon.getRootTypeFromVolumeType = volumeType => {
  switch (volumeType) {
    ...
    case VolumeManagerCommon.VolumeType.JEMADROP:
      return VolumeManagerCommon.RootType.JEMADROP;
  }
