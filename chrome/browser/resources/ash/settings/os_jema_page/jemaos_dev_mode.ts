...
import {getTemplate} from './jemaos_dev_mode.html.js';
import {loadTimeData} from 'chrome://resources/js/load_time_data.js';

const JemaSettingsDevModePageElementBase =
    WebUiListenerMixin(I18nMixin(PolymerElement));

/** @polymer */
class JemaSettingsDevModePageElement extends JemaSettingsDevModePageElementBase {
  static get is() {
    return 'os-settings-jemaos-dev-mode';
  }
  static get template() {
    return getTemplate();
  }
...
customElements.define(
    JemaSettingsDevModePageElement.is, JemaSettingsDevModePageElement);
