  ...
  web_app::CreateIconInfoForSystemWebApp(
      info->start_url(),
      {
          {"camera_app_icons_48.png", 48,
           IDR_ASH_CAMERA_APP_IMAGES_JEMAOS_CAMERA_APP_ICONS_48_PNG},
          {"camera_app_icons_128.png", 128,
           IDR_ASH_CAMERA_APP_IMAGES_JEMAOS_CAMERA_APP_ICONS_128_PNG},
          {"camera_app_icons_192.png", 192,
           IDR_ASH_CAMERA_APP_IMAGES_JEMAOS_CAMERA_APP_ICONS_192_PNG},
      },
      *info);
