...
void CoreOobeHandler::DeclareLocalizedValues(
  ...
  if (!has_api_keys_configured && !has_jema_oauth_client_configured && is_oobe_display_) {
  ...
  } else if (has_api_keys_configured && !has_jema_oauth_client_configured && is_oobe_display_) {
