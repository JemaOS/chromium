...
import './screens/common/jema_local_signin.js';
...
import './screens/common/jemaos_installer.js';
...
export const commonScreensList: OobeTypes.ScreensList = [
  ...
  {tag: 'jema-local-signin-element', id: 'jema-local-signin'},
