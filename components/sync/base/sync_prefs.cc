...
void SyncPrefs::RegisterProfilePrefs(PrefRegistrySimple* registry) {
  ...
  //---***JEMAOS BEGIN***---
  registry->RegisterBooleanPref(prefs::kSyncKeepEverythingSynced, !jemaos::switches::IsJemaAccountEnabled());
  //---***JEMAOS END***---
...
void SyncPrefs::RegisterTypeSelectedPref(PrefRegistrySimple* registry,
  ...
  DCHECK(pref_name);
  //---***JEMAOS BEGIN***---
  registry->RegisterBooleanPref(pref_name, jemaos::switches::IsJemaAccountEnabled()
