...
import {getTemplate} from './jemaos_drivers.html.js';
...
class DriverClient {
  ...
  static get touchpadConfigFile() {
    return '/etc/modprobe.d/jemaos-psmouse.conf';
  }
...
const JemaSettingsDriversPageElementBase = 
...
/** @polymer */
class JemaSettingsDriversPageElement extends JemaSettingsDriversPageElementBase {
  static get is() {
    return 'os-settings-jemaos-drivers' as const;
  }
  ...
  constructor() {
    super();
    console.log('os-settings-jemaos-drivers ready');
  ...
  override connectedCallback() {
    ...
    console.log('os-settings-jemaos-drivers attached');
    this.updateDrivers_();
  }
...
customElements.define(
    JemaSettingsDriversPageElement.is, JemaSettingsDriversPageElement);
