...
class LocalPasswordSetupView {
 public:
  ...
  virtual void Show(bool can_go_back, bool is_recovery_flow, bool is_jema_profile) = 0;
...
class LocalPasswordSetupHandler final : public BaseScreenHandler,
 ...
 public:
  ...
  void Show(bool can_go_back, bool is_recovery_flow, bool is_jema_profile) override;
