...
export class OsSettingsMainElement extends OsSettingsMainElementBase {
  ...
  static get properties() {
    return {
      ...
      showPages_: {
        type: Object,
        value() {
          return {about: false, settings: false, jemaos: false};
        },
      },
  ...
  override currentRouteChanged(newRoute: Route) {
    ...
    const inJemaOs = routes.JEMAOS.contains(Router.getInstance().currentRoute);
    this.showPages_ = {about: inAbout, settings: !inAbout && !inJemaOs, jemaos: inJemaOs};
