...
COMPONENT_EXPORT(GOOGLE_APIS) bool HasJemaOSAPIKeyConfigured();
...
COMPONENT_EXPORT(GOOGLE_APIS) const std::string& GetJemaOSAPIKey();
...
#if BUILDFLAG(IS_OPENJEMA)
COMPONENT_EXPORT(GOOGLE_APIS) bool HasJemaOAuthClientConfigured();
#endif
