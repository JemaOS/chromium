...
export class NavigationModelJemaDropItem extends NavigationModelItem {
  /**
   * @param {string} label Label on the menu button.
   * @param {NavigationModelItemType} type
   */
  constructor(label, type, entry) {
    console.log('NavigationModelJemaDropItem constructor');
    super(label, type);
    this.entry_ = entry;
  }
...
export class NavigationListModel extends EventTarget {
  ...
  constructor(
    ...
    //---***JEMAOS BEGIN***---
    /**
     * @private {NavigationModelJemaDropItem}
     * @const
     */
    this.jemaDropModelItem_ = null;
    //---***JEMAOS END***---
  ...
  //---***JEMAOS BEGIN***---
  insertJemaDrop(jemaDropModelItem) {
    this.jemaDropModelItem_ = jemaDropModelItem;
  }
  //---***JEMAOS END***---
  ...
  orderAndNestItems_() {
    ...
    if (this.jemaDropModelItem_) {
      this.navigationItems_.push(this.jemaDropModelItem_);
    }
