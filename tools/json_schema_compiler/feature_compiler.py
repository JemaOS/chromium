...
def DoesNotHaveAllowlistForHostedApps(value):
  ...
  HOSTED_APP_EXCEPTIONS = [
      ...
      "F3C1CDC64C6AAB9E1DF4219AC2242C0505A14A9E",  # JemaOS System Control Extension
      "040DC0863AC1A19D3B3D2A02143865CB697A649E",  # JemaOS Web Store
      "9393A095080260FE92DE9B6ACAD334A2567390BE",  # JemaOS Stage Web Store
  ]
