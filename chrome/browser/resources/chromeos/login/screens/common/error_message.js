...
class ErrorMessageScreen extends ErrorMessageScreenBase {
  ...
  updateLocalizedContent() {
    ...
    this.$$('#jema-local-signin-link')
        .addEventListener('click', this.advanceToJemaLocalSignin_.bind(this));
  ...
  allowJemaLocalSignin(allowed) {
    this.jemaLocalSigninAllowed_ = allowed;
  }
