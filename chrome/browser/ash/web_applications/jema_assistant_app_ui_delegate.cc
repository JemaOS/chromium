#include "chrome/browser/ash/web_applications/jema_assistant_app_ui_delegate.h"
...
ChromeJemaAssistantAppUIDelegate::ChromeJemaAssistantAppUIDelegate(content::WebUI* web_ui)
    : web_ui_(web_ui) {}

ChromeJemaAssistantAppUIDelegate::~ChromeJemaAssistantAppUIDelegate() = default;

void ChromeJemaAssistantAppUIDelegate::PopulateLoadTimeData(content::WebUIDataSource* source) {
...
ash::JemaAssistantAppUIDelegate::ColorInfo ChromeJemaAssistantAppUIDelegate::GetSystemColorInfo() {
