...
void AuthSessionAuthenticator::CompleteLoginImpl(
  ...
  DCHECK(context->GetUserType() == user_manager::USER_TYPE_REGULAR ||
         context->GetUserType() == user_manager::USER_TYPE_JEMA_ACCOUNT ||
         context->GetUserType() == user_manager::USER_TYPE_FLINT_ACCOUNT ||
         context->GetUserType() == user_manager::USER_TYPE_JEMA_CHILD ||
...
void AuthSessionAuthenticator::AuthenticateToUnlock(
  ...
  DCHECK(user_context->GetUserType() == user_manager::USER_TYPE_REGULAR ||
         user_context->GetUserType() == user_manager::USER_TYPE_JEMA_ACCOUNT ||
         user_context->GetUserType() == user_manager::USER_TYPE_FLINT_ACCOUNT ||
         user_context->GetUserType() == user_manager::USER_TYPE_JEMA_CHILD ||
