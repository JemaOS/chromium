...
import {getTemplate} from './jemaos_experiment.html.js';

const JemaSettingsExperimentPageElementBase =
...
/** @polymer */
class JemaSettingsExperimentPageElement extends JemaSettingsExperimentPageElementBase {
  static get is() {
    return 'os-settings-jemaos-experiment';
  }
  ...
  static get properties() {
    return {
      ...
      jemaExperimentTpmfallbackUrl_: {
        type: String,
        value: loadTimeData.getString('jemaExperimentTpmfallbackUrl'),
      }
    };
  }
...
customElements.define(
    JemaSettingsExperimentPageElement.is, JemaSettingsExperimentPageElement);
