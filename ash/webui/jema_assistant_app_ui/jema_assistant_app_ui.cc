...
JemaAssistantAppUI::JemaAssistantAppUI(content::WebUI* web_ui,
  ...
  html_source->AddString("jemaosAssistantUrl", jemaos::switches::GetJemaOSAssistantWebUrl());
  html_source->AddBoolean("isJemaOSAssistantEnabled", ash::AssistantState::Get()->jema_assistant_enabled().value_or(false));
